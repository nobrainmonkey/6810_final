...
double get_ising_energy(int row, int col, double T, int iteration,
                        int sample_size,
...
double get_ising_heat_capacity(int row, int col, double T, int iteration,
                               int sample_size,
                               hamiltonian_param_struct *hamiltonian_param_ptr);
...
double get_ising_m(int row, int col, double T, int iteration, int sample_size,
                   hamiltonian_param_struct *hamiltonian_param_ptr);
...
double get_ising_chi(int row, int col, double T, int iteration, int sample_size,
                     hamiltonian_param_struct *hamiltonian_param_ptr);
