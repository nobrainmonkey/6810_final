...
double get_ising_energy(int row, int col, double T, hamiltonian_param_struct* hamiltonian_param_ptr);
...
double get_ising_heat_capacity(int row, int col, double T, double dT, hamiltonian_param_struct* hamiltonian_param_ptr);
...
double get_ising_entropy(int row, int col, double T, hamiltonian_param_struct* hamiltonian_param_ptr);

// function prototype for calculating 
// magnetization of a microstate of a given
// dimension row x col and a given hamiltonian parameters.
double get_ising_m(int row, int col, double T, hamiltonian_param_struct* hamiltonian_param_ptr); 
...
double get_ising_chi(int row, int col, double T, hamiltonian_param_struct* hamiltonian_param_ptr, double dh); 
